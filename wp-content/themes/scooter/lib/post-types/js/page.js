(function ($) {
	...
	function pageType()
    {
        var $container = $('.px-main'),
            ...
            $sec = $container.find('.section-page-position-switch,.section-show-in-menu-switch,.section-page-sidebar, .section-blog-sidebar ,.section-portfolio-skill,.section-footer-widget-area,.section-layerslider,.section-footer-map,.section-parallax-options,.section-blog-type-switch,.section-Overlay-options,.section-video-options,.section-portfolio-detail-ajax,.section-portfolio-posts-page,.section-portfolio-filter-nav'),
			$postdivrich = $('#postdivrich'),
        ...
        $pageType.change(function(){
            var $selected = $pageType.find('option:selected'),
				...
				else if ( val == 'parallax-section' )
				{
					$selected = $container.find('.section-show-in-menu-switch,.section-parallax-options,.section-Overlay-options');
				}
				else if ( val == 'portfolio-section'  && positionVal == '0' )
				{
					$selected = $container.find('.section-page-position-switch,.section-portfolio-detail-ajax,.section-show-in-menu-switch,.section-portfolio-skill,.section-portfolio-posts-page,.section-portfolio-filter-nav');
				}
				else if ( val == 'portfolio-section'  && positionVal == '1' )
				{
					$selected = $container.find('.section-page-position-switch,.section-show-in-menu-switch,.section-portfolio-skill,.section-footer-widget-area,.section-layerslider,.section-footer-map,.section-portfolio-posts-page,.section-portfolio-filter-nav');
				}
				...
				{
				    $selected = $container.find('.section-page-position-switch,.section-blog-type-switch ,.section-footer-widget-area,.section-footer-map,.section-layerslider');
				}
				else if (val == 'blog-section' && positionVal == '1' && blogTypeVal == '1')
				{
				    $selected = $container.find('.section-page-position-switch,.section-blog-sidebar,.section-blog-type-switch,.section-footer-widget-area,.section-footer-map,.section-layerslider');
				}
				else if ( val == 'video-section'  && positionVal == '0' )
				{	
					$selected = $container.find('.section-video-options,.section-page-position-switch,.section-show-in-menu-switch,.section-Overlay-options');	
				}
				else if ( val == 'video-section'  && positionVal == '1' )
				{
					$selected = $container.find('.section-video-options,.section-page-position-switch,.section-footer-widget-area,.section-footer-map,.section-layerslider,.section-Overlay-options');
				}
