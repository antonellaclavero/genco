...
class PixFlow_Facebook_Widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'page_url' ); ?>"><?php _e('Facebook Page URL :', TEXTDOMAIN) ?> <small"> Example: http://www.facebook.com/envato </small"></small>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_faces' ); ?>"><?php _e('Show Faces:', TEXTDOMAIN) ?></label>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'show_faces' ); ?>" name="<?php echo $this->get_field_name( 'show_faces' ); ?>" <?php checked( (bool) $instance['show_faces'], true ); ?> />
		</p>
        
        <!-- Show Stream  : Check Box -->
		<p>
			<label for="<?php echo $this->get_field_id( 'show_stream' ); ?>"><?php _e('Show Stream:', TEXTDOMAIN) ?></label>
            <input type="checkbox" id="<?php echo $this->get_field_id( 'show_stream' ); ?>" name="<?php echo $this->get_field_name( 'show_stream' ); ?>" <?php checked( (bool) $instance['show_stream'], true ); ?> />
		</p>
        
        <!--Like Box Width : Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'width' ); ?>"><?php _e('like box width:', TEXTDOMAIN) ?></label>
            <input type="text" id="<?php echo $this->get_field_id( 'width' ); ?>" name="<?php echo $this->get_field_name( 'width' ); ?>" value="<?php echo esc_attr( $instance['width'] ); ?>" />
		</p>
        
        <!-- Like Box Height  : Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'height' ); ?>"><?php _e('Like box height :', TEXTDOMAIN) ?></label>
