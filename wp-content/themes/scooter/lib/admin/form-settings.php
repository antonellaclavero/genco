...
function px_admin_get_defaults()
{
    ...
    $presetColors['default'] = px_admin_get_color_option_attr(
        array('style-accent-color'=>'#d7c3a8',
              'style-highlight-color'=>'#d7c3a8',
              'style-link-color'=>'#d7c3a8',
    ...
    $preloaderPanel = array(
        ...
        'sections' => array(
           ...
           'preloader_style' => array(
                'title'   => __('Preloader Style', TEXTDOMAIN),
                'tooltip' => __('You can choose preloader style here.', TEXTDOMAIN),
                'fields'  => array(
                    'preloader_style' => array(
                        'type'   => 'switch',
                        'state0' => __('Fade', TEXTDOMAIN),
                        'state1' => __('Grow', TEXTDOMAIN),
                        'value'  => 1
                    ),
                )
            ),//Pre Loader Style 
            ...
            'preloader-logo' => array(
                'title'   => __('Loader Logo', TEXTDOMAIN),
                'tooltip' => __('Insert a logo which will be shown on loading page.', TEXTDOMAIN),
                'fields'  => array(
                    'preloader-logo' => array(
                        'type' => 'upload',
        ...
        'sections' => array(
            'header-style' => array(
                ...
                'fields'  => array(
                    'header-style' => array(
                        'type'   => 'select',
                        'options'=> array('scooter-menu' => 'Scroll to fade-in with logo','fixed-menu' => 'Sticky Menu', 'scroll-sticky' => 'Scroll to fade-in'),
                        'default'=> 'fixed-menu',
                    ),
                )
            ),//Menu Style
           ...
           'home-type' => array(
                ...
                'fields'  => array(
                    'home-type-switch' => array(
                        'type'   => 'select',
                        'options'=> array('home-slider' => 'FullScreen Slider', 'home-video' => 'FullScreen Video', 'home-map' => 'FullScreen Google Map', 'home-layerSlider' => 'Layer Slider')
                    ),
                )
            ...
            'widget-areas' => array(
                ...
                'fields'  => array(
                    'footer_widgets' => array(
                        'type' => 'visual-select',
                        'options' => array('zero' => 0, 'one'=>1, 'Six-Six'=>2, 'eight-four'=>3, 'four-eight'=>4),
            ...
            'copyright-message' => array(
                ...
                'fields'  => array(
                    'footer-copyright' => array(
                        ...
                        'value' => '&copy; 2014 PixFlow is proudly powered by <a href="http://wordpress.org">WordPress</a> | Built With Scooter Theme'
                    ),//footer_copyright sec
                )
            ),//widget-areas sec
            'footer-banner' => array(
                'title'   => __('Footer Background Image', TEXTDOMAIN),
                'tooltip' => __('Upload an image to be shown as footer background image', TEXTDOMAIN),
                'fields'  => array(
                    'footer-banner' => array(
                        'type' => 'upload',
                        'label' => __('Footer Banner', TEXTDOMAIN),
            ...
            'import-dummy-data' => array(
                ...
                'fields'  => array(
                    'demo-dummy-data' => array(
                        ...
                        'type'   => 'select',
                        'options'=> array(
                            'agency' => 'Agency - Creative Demo',
                            'vintage'=> 'Vintage - Creative Demo',
                            'sensation'=> 'Sensation - Creative Demo',
                            'flat'=> 'Flat - Creative Demo',
                            'travel' => 'Travel - Creative Demo',
                            'engineering' => 'Engineering - Business Demo',
                            'business' => 'Business - Business Demo',
                            'gym' => 'Gym - Business Demo',
                            'corporate' => 'Corporate - MultiPage Demo',
                            'flaty' => 'Flaty - MultiPage Demo',
                            'features' => 'Features - MultiPage Demo',
                            'resturant' => 'Resturant - Creative Demo'
                        ),
                    ),
                    'import-dummy-data' => array(
                        'type'   => 'switch',
    ...
    $tabGroups = array(
        'theme-settings' => array( 'text' => __('Theme Settings', TEXTDOMAIN), 'tabs' => array('general',  'appearance' , 'preloader', 'menu',  'header' , 'headerstyle' , 'headerStartBtn' ,  'blog', 'fonts', 'sidebar', 'woocomerce' , 'footer', 'social' /* , 'api' */ ) ),
    ...
    $settings = array(
        'document-url' => 'http://demo.pixflow.net/promo/scooter/documentation/',
