(function ($) {
    ...
    function iconSelect() {
        ...
        $('input[name^=header-icon]').each(function () {
    ...
    function ColorPicker() {
		...
		$('#preloader .colorinput , #header .colorinput , #menu .colorinput , #headerstyle .colorinput , #headerStartBtn .colorinput , #footer .colorinput').each(function () {
            var $input  = $(this),
                $parent = $input.parent(),
				$picker = $('<div class="color-selector"><div></div></div>'),
				col     = $input.val();
	...
	function HomeType()
    {
	    var $container = $('#header'),
            ...
            $sec = $container.find('.section-home-video,.section-home-map,.section-home-layerSlider,.section-home-slider');
        ...
        $menuStyle.change(function(){
			...
			if ( val == 'fixed-menu' || val == 'scroll-sticky'  ) {
				...
				$(".section-logo-second , .section-logo").slideDown('fast').next('hr').show();
			}
