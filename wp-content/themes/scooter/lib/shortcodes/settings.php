...
$pxScTemplate['testimonial'] = array(
    ...
    'fields' => array(
        'name' => array(
            'type'  => 'text',
            'title' => __('Opinion Title', TEXTDOMAIN),
            'desc'  => __('Enter Opinion Title', TEXTDOMAIN),
            'flags' => 'attribute,empty-remove',//CSV
        ),
        'comment' => array(
            'type' => 'textarea',
            'title' => __('Opinion', TEXTDOMAIN),
            'desc'  => __('Enter the opinion here', TEXTDOMAIN),
            'flags' => 'attribute',//CSV
        ),
        'talker_name' => array(
            'type'  => 'text',
            'title' => __('Name', TEXTDOMAIN),
            'desc'  => __('Name of person who said the opinion', TEXTDOMAIN),
            'flags' => 'attribute,empty-remove',//CSV
        ),
        'skin' => array(
            'type'  => 'select',
    ...
    'fields' => array(
        ...
        'sociallink_type' => array(
            ...
            'options' => array(
                ...
                'icon-steam' => 'steam',
                'icon-reddit' => 'reddit',
                'icon-stumbleupon2' => 'stumbleupon',
                'icon-pinterest' => 'pinterest',
                'icon-deviantart2' => 'deviantart',
                'icon-xing2' => 'xing',
