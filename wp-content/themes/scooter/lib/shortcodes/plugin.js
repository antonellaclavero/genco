	...
	tinymce.create("tinymce.plugins.pxShortcodes",
	{
		...
		createControl: function ( button, e )
		{
			...
			button.onRenderMenu.add(function (c, b)
			{
				...
				plugin.addPopupMenuButton(c, "Testimonial Group", "testimonial_group");
				...
				plugin.addPopupMenuButton(c, "Icon Box", "iconbox");
                ...
                //plugin.addImmediateMenuButton(c, "1/2 + 1/2", "[row top-space='' bottom-space='']<br />[span6][/span6]<br />[span6][/span6]<br />[/row]");
                //plugin.addImmediateMenuButton(c, "1/3 + 1/3 + 1/3", "[row top-space='' bottom-space='']<br />[span4][/span4]<br />[span4][/span4]<br />[span4][/span4]<br />[/row]");
                //plugin.addImmediateMenuButton(c, "2/3 + 1/3", "[row top-space='' bottom-space='']<br />[span8][/span8]<br />[span4][/span4]<br />[/row]");
                //plugin.addImmediateMenuButton(c, "1/4 + 1/4 + 1/4 + 1/4", "[row top-space='' bottom-space='']<br />[span3][/span3]<br />[span3][/span3]<br />[span3][/span3]<br />[span3][/span3]<br />[/row]");
                //plugin.addImmediateMenuButton(c, "3/4 + 1/4", "[row top-space='' bottom-space='']<br />[span9][/span9]<br />[span3][/span3]<br />[/row]");
                ...
                //plugin.addImmediateMenuButton(c, "Row", "[row top-space='' bottom-space='']<br />[/row]");
