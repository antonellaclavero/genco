<?php 
    ...
    $pPostPerPage  = get_post_meta(get_the_ID(), "portfolio-posts-page", true);
    $pfilterNav  = get_post_meta(get_the_ID(), "portfolio-filter-nav", true);
    $pfilter  = get_post_meta(get_the_ID(), "portfolio-filter", true);
    ...
    if(count($catArr) == 0 || count($catArr) > 1)
    {
        ...
        $catList = '<li class="current"><a class="active" data-filter="*" href="#">'.__('All', TEXTDOMAIN)."</a></li>";
    ...
    <div id="<?php echo $post->post_name;?>" class="wrap">
        ...
        <div class="container pDWrap clearfix">
            ...
            <div id="pDError"><?php _e('Sorry, we ran into a technical problem (unknown error). Please try again...', TEXTDOMAIN) ?> </div>
             ...
             <div class="navCloseWrap">
                 <!-- Close button -->
                <div id="pDClose" class="close"><a href="#"></a></div>

                <!-- Navigation -->
                <ul  id="pDNavigation" class="navigation">
                    <li class="next">
                        <a href="#"></a>
                    </li>
                    <li class="previous">
        ...
        <?php
            ...
            if ( $query-> have_posts()) { ?>
                ...
                <div class="pLoadMore <?php echo $pLoadMore; ?>  clearfix"></div>
