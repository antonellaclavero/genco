        ...
        if ( px_opt('home-display-switch')) {
            ...
            if( have_posts() ) :
                ...
                if (($separate_page !== "1" )&& ($post_id != $current_page_id ))
                    {
                        // parallax section
                        if ( get_post_meta( $post_id, "page-type-switch", true ) == "parallax-section") {

                            get_template_part( 'templates/section', 'parallax' );

                        }
                        // custom section
                        else if ( get_post_meta( $post_id, "page-type-switch", true ) == "custom-section") {
                        ...
                        // Video section
                        else if ( get_post_meta( $post_id, "page-type-switch", true ) == "video-section") {
